...
with st.echo(code_location='below'):
    ...
    st.write("Тут есть Pandas, визуализации, Numpy, streamlit, folium, networkx, много строк, общая тема, и шутки, которые компенсируют плохие графики. Теперь можем и отдохнуть ♡")